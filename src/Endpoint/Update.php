 ...
 * @property PredicateSet or
 */
class Update implements EndpointInterface, QueryInterface, RoutingInterface {
     ...
     * @param array        $params
     */
    public function __construct(Client $client, string|array $index, string $script, array $params = []) {
        $this->_client = $client;
        $this->_script = $script;
        $this->_params = $params;
